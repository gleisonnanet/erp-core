 ...
 */
Route::group(['middleware' => ['auth'], 'namespace' => '\erp-core\Http\Controllers'], function() {
 ...
 */
Route::group(['middleware' => ['auth', 'setup'], 'namespace' => '\erp-core\Http\Controllers'], function() {
